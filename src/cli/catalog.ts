...
export const catalog: ReadonlyArray<CommandSpec> = [
  ...
  {
    name: "story set",
    about: "Write the reading order for this worktree's diff: ordered steps over spans of files",
    safety: "write",
    options: [
      { name: "worktree", required: true, value: "path", about: "The worktree the story is about" },
      {
        name: "json",
        required: true,
        value: "file|-",
        about: "The story document, as a file path or - to read stdin",
      },
    ],
    dataKey: "story",
    example: "adiff story set --worktree . --json -",
  },
  {
    name: "story show",
    about: "The story of a worktree, with the hunks no step claims",
    safety: "read",
    options: [
      { name: "worktree", required: true, value: "path", about: "The worktree to read" },
    ],
    dataKey: "story",
    example: "adiff story show --worktree . --fields steps,uncovered",
  },
  {
    name: "review open",
