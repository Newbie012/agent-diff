...
const commands: ReadonlyArray<CommandSpec> = [
  ...
  {
    name: "remark list",
    about: "Every remark on the branch's pull request, with who left it and whether it is triaged",
    group: FOLLOW_UP,
    addresses: "review",
    safety: "read",
    options: [...addressing],
    dataKey: "remarks",
    example: "adiff remark list --repo . --branch add-invitations",
  },
  {
    name: "remark accept",
    about: "Take a remark on as your own comment, so the agent picks it up",
    group: FOLLOW_UP,
    addresses: "review",
    safety: "write",
    options: [
      ...addressing,
      { name: "id", required: true, value: "id", about: "The remark to accept" },
      {
        name: "body",
        required: false,
        value: "text",
        about: "What to tell the agent, instead of the remark's own words",
      },
    ],
    dataKey: "accepted",
    example: "adiff remark accept --repo . --branch add-invitations --id PRRT_kw",
  },
  {
    name: "remark reply",
    about: "Answer a remark in its thread on the pull request",
    group: FOLLOW_UP,
    addresses: "review",
    safety: "write",
    options: [
      ...addressing,
      { name: "id", required: true, value: "id", about: "The remark to answer" },
      { name: "body", required: true, value: "text", about: "What to say in the thread" },
    ],
    dataKey: "answered",
    example: 'adiff remark reply --repo . --branch add-invitations --id PRRT_kw --body "fair, done"',
  },
  {
    name: "remark dismiss",
    about: "Take a remark out of this review. It stays on the pull request",
    group: FOLLOW_UP,
    addresses: "review",
    safety: "write",
    options: [
      ...addressing,
      { name: "id", required: true, value: "id", about: "The remark to dismiss" },
    ],
    dataKey: "dismissed",
    example: "adiff remark dismiss --repo . --branch add-invitations --id PRRT_kw",
  },
  {
    name: "remark restore",
    about: "Put a dismissed remark back into this review",
    group: FOLLOW_UP,
    addresses: "review",
    safety: "write",
    options: [
      ...addressing,
      { name: "id", required: true, value: "id", about: "The remark to restore" },
    ],
    dataKey: "restored",
    example: "adiff remark restore --repo . --branch add-invitations --id PRRT_kw",
  },
  {
